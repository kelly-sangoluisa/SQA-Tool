            ...
            <div className={`status-badge ${report.meets_threshold ? 'status-badge--success' : 'status-badge--warning'}`}>
              {report.meets_threshold ? (
                <>
                  ...
                  {report.satisfaction_grade || 'Proyecto Aprobado'} (Umbral: {report.minimum_threshold})
                </>
              ) : (
                <>
                  ...
                  {report.satisfaction_grade || 'Proyecto No Aprobado'} (Umbral: {report.minimum_threshold})
                </>
              )}
            </div>
          </div>
